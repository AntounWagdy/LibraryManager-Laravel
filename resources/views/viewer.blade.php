...
<body>
  ...
  <div class="s007">
    ...
    <div class="advance-search">
      ...
      <div class="row">
        <button type="button" data-id="{{$item['ID']}}" onclick="showBorrows(this)" class="btn-search">عرض الإستعارات</button>
      ...
      <div class="row">
        <button type="button" data-id="{{$item['ID']}}" onclick="borrow(this)" class="btn-search">إستعر</button>
        <p class="author" type="text" style="visibility: hidden;">داتا</p>
        <p class="author" type="text" style="visibility: hidden;">عدد النسخ</p>
  ...
  <script>
    ...
    function borrow(ele) {
      ...
      confirmBtn.addEventListener("click", function onOpen() {
        // send php request
        window.location.assign("/borrow?id=" + dataid + "&class=" + classinput.options[classinput.selectedIndex].text +
